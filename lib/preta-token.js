...
/**
 * Create the short-lived signed context token consumed by the Preta loader
 * via `window.__PRETA_CTX__` + `data-ctx-var`. Claims: plan, risk_score,
 * account_type (+ role/email for convenience).
